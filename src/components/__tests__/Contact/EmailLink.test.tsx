...
describe('EmailLink', () => {
  ...
  it('renders the email domain', () => {
    ...
    expect(screen.getByText('santiago.rodriguez.bedate@gmail.com')).toBeInTheDocument();
  });
  ...
  it('generates valid mailto href for valid email prefixes', () => {
    ...
    const link = screen.getByRole('link');
    expect(link.getAttribute('href')).toBe('mailto:santiago.rodriguez.bedate@gmail.com');
  });
